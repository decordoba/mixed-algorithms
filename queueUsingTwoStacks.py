...
two stacks to make a queue. In the code I have implemented both queue types: one using a python
list, and another using two python lists treated like stacks.

From HackerRank: A queue is an abstract data type that maintains the order in which elements were
added to it, allowing the oldest elements to be removed from the front and new elements to be
added to the rear. This is called a First-In-First-Out (FIFO) data structure because the first
