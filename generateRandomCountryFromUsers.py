...
My interviewer wanted me to do some kind of binary search, like it is done in
country_random_generator2 but the only reason to do it in this way is if the input was some kind
of hash table with the number of appearances of every country instead of a country list. Anyway,
...
if __name__ == "__main__":
    default = ("Spain Usa France Usa Spain India China China India India China Usa Usa Usa " +
               "Canada China China China China China India")
    inp = readInputArguments(input=default)
    parsed_input = parseString(inp)[0]
